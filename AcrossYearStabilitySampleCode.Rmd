...
All of the following analyses use the data file pregnancydataset.RData which is the same as used in the seasonl paper. For some portions of this code, capture data including the individual ages is also used. A subset of the capturedatabase including just the required info for those specific individuals is referenced in this code. 
...
#load in and rename the dataset and the required packages
